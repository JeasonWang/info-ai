...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `status` VARCHAR(20) NOT NULL DEFAULT 'active' COMMENT '事件状态：active/monitoring/low_quality/archived/hidden',
  `display_quality_score` INT NOT NULL DEFAULT 0 COMMENT '展示质量分',
  `display_quality_level` VARCHAR(20) NOT NULL DEFAULT '' COMMENT '展示质量等级: excellent/good/weak/blocked',
  `display_quality_reason` VARCHAR(500) NOT NULL DEFAULT '' COMMENT '展示质量原因，逗号分隔',
